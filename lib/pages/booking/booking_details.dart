...
import 'package:practice_login/pages/feedback_page.dart';
...
class _BookingDetailsState extends State<BookingDetails> {
  ...
  void feedbackPage(String freelancerID){
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => Ratings(freelancerID:freelancerID)
        )
    );
  }
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Padding(padding: EdgeInsets.only(left: 10, top: 15), child: Text('Booking Details')),
        actions: [
          Padding(
                      ...
                      children: [
                              ...
                              child: Column(
                                children: [
                                  Container(
                                    ...
                                    child: widget.asFreelancer ? const Text('Client message', style: TextStyle(fontSize: 16, fontStyle: FontStyle.italic)) : const Text('Your message', style: TextStyle(fontSize: 16, fontStyle: FontStyle.italic)),
                                  ),
                                  SizedBox(
                                    width: width,
                                    child: Text(_bookingDetails['message'], style: const TextStyle(fontSize: 16)),
                                  )
                                ],
                              ),
                            )
                        ...
                        if (_bookingDetails['to_dos'].isNotEmpty)
                          Container(
                            ...
                            width: width,
                            child: const Text('To Dos', style: TextStyle(fontSize: 16)),
                          ),
                        if (_bookingDetails['to_dos'].isNotEmpty)
                          Container(
                              ...
                              GestureDetector(
                                      ...
                                      builder: (context) {
                                        return WarningDialog(
                                            ...
                                            confirmAction: () {
                                              ...
                                              Navigator.pop(context);
                                              Navigator.pop(context);
                                              feedbackPage(clientFreelancerData['freelancer']['uid']);
                                            }
                                        );
                                      }
                                  );
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: widget.asFreelancer ? const Color.fromARGB(100, 70, 199, 177) : const Color.fromARGB(255, 70, 199, 177),
        ...
        Align(
          ...
          child: Padding(
            ...
            child: AnimatedOpacity(
              ...
              child: IconButton(
                  onPressed: () {
                    toDoController.animateToPage(widget.toDo.length - 1, duration: const Duration(milliseconds: 400), curve: Curves.linearToEaseOut);
                  },
                          ...
                          showDialog(
                              ...
                              builder: (context) {
                                return WarningDialog(
                                    ...
                                    confirmOverlayColor: _isChecked ? const Color.fromRGBO(255, 0, 0, 0.1) : const Color.fromRGBO(0, 255, 0, 0.1),
